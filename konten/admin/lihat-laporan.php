          ...
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            ...
            <div class="container">
              <div class="row">
                <div class="col-md-12">
                  <div class="card">
                    <div class="card-header bg-gradient-primary text-white" style="font-size: 19px; font-weight: bold; text-shadow: 1px 1px 1px rgba(0, 0, 0, .8);">Halaman Lihat Data Laporan </div>
                    <div class="card-body">
                          ...
                          <?php foreach ($png as $data) : ?>
                            <tbody>
                              <tr>
                                ...
                                <td><?= $data["status"]; ?></td>
                                <td>
                                  <a href="hapus-laporan.php?id=<?= $data["id_pengaduan"]; ?>" onclick="return confirm('Yakin Nii')" class="btn btn-danger">
