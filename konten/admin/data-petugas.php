          ...
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            ...
            <div class="container">
              <div class="row">
                <div class="col-md-12">
                  <div class="card">
                    <div class="card-header bg-gradient-primary text-white" style="font-size: 19px; font-weight: bold; text-shadow: 1px 1px 1px rgba(0, 0, 0, .8);">Halaman Data Petugas </div>
                    <div class="card-body">
                      <a href="tambah-petugas.php" class="btn btn-success mb-3">Tambah Petugas</a>
                      <div class="table-responsive">
                        <table cellpadding="10" cellspacing="0" class="table  table-bordered text-center">
                          <thead>
                            <tr>
                              <th>No</th>
                              <th>Nama Petugas</th>
                          ...
                          <?php foreach ($png as $data) : ?>
                            <tbody>
                              <tr>
                                ...
                                <td><?= $data["status"]; ?></td>
                                <td>
                                  <a href="hapus-data.php?id=<?= $data["id_petugas"]; ?>" onclick="return confirm('Yakin Nii')" class="btn btn-danger">
