          ...
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            ...
            <div class="container">
              <div class="row">
                <div class="col-md-12">
                  <div class="card">
                    <div class="card-header bg-primary text-white" style="font-size: 19px; font-weight: bold; text-shadow: 1px 1px 1px rgba(0, 0, 0, .8);">Halaman Tanggapan Pengaduan </div>
                    <div class="card-body">
                      <?php
                      require '../fungsiindex.php';
                      $id = $_GET["id"];
                      $result = mysqli_query($con, "SELECT * FROM pengaduan WHERE id_pengaduan = $id");
                      $data = mysqli_fetch_assoc($result);
                      if ($result) :
                      ?>
                        <a href="verifikasi-admin.php" class="btn btn-danger btn-icon-split">
                        ...
                        <form action="simpan-tanggapan.php" method="post">
                          <div class="form-group">
                            <label for="" class="mt-3">Id pengaduan:</label>
                            <input type="text" name="id_pengaduan" value="<?= $_GET["id"]; ?>" class="form-control">
                            <label for="tgl" class="mt-3"> Tgl_Pengaduanya :</label>
                            <input type="date" name="tgl_tanggapan" class="form-control" value="<?= date("Y-m-d") ?>" id="tgl" readonly>
                            <label for="isi" class="mt-3"> Isi Tanggapan :</label>
                            <textarea name="tanggapan" id="isi" style="height: 100px;" class="form-control">
                            </textarea>
                            <label for="" class="mt-3">Id Petugas:</label>
                            <input type="text" name="id_petugas" value="<?= $_SESSION["id_petugas"]; ?>" class="form-control">
                            <br>
                            <button type="submit" value="tanggapi" name="tanggap" class="btn btn-primary btn-user">
                              <span class="icon text-white-50">
                                <i class="fas fa-check"></i>
                              </span>
