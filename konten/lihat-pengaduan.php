          ...
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            ...
            <div class="container-fluid">
              <div class="row">
                <div class="col-md-12">
                  <div class="card">
                    <div class="card-header bg-gradient-success text-white" style="font-size: 19px; font-weight: bold; text-shadow: 1px 1px 1px rgba(0, 0, 0, .8);">Halaman Lihat Pengaduan </div>
                    <div class="card-body">
                      <form action="" method="post">
                        <div class="form-group">
                          <input type="text" class="form-control" name="Keyword" placeholder="Masukkan Nik Untuk Mencari Data" autocomplete="off" autofocus >
                          <button type="submit" name="cari" class="btn btn-success mt-2">CARI DATA!</button>
                        </div>
                          ...
                          <?php foreach ($png as $data) : ?>
                            <tbody>
                              <tr>
                                ...
                                <td><?= $data["status"]; ?></td>
                                <td><a href="detail.php?id=<?= $data["id_pengaduan"];  ?>" class="btn btn-success">D</a> <a href="lihat-tanggapan.php?id= <?= $data["id_pengaduan"]; ?>" class="btn btn-primary">V </a></td>
                              </tr>
                            </tbody>
                            <?php $i++; ?>
                          <?php endforeach; ?>
