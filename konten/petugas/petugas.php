            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0" style="color: black; text-shadow: 1px 1px 1px rgba(0, 0, 0, .4);">Dashboard petugas</h1>
                    </div>

                    <!-- Content DATA -->
                    <div class="row">
                        <div class="col-md-12">
                            <p style="font-size: 20px; color: black; font-family: 'Recursive', sans-serif; font-style: italic; color:black;">Hallo "<?php echo $_SESSION["status"]; ?>"  , Your Name : <?php echo $_SESSION["nama_petugas"]; ?> </p>
                        </div>

                        <?php
                        require '../fungsiindex.php';
                        $result = mysqli_query($con, "SELECT * FROM pengaduan WHERE status ='0'");
