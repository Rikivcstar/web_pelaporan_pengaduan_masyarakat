          ...
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            ...
            <div class="container">
              <div class="row">
                <div class="col-md-12">
                  <div class="card">
                    <div class="card-header bg-gradient-warning text-white" style="font-size: 19px; font-weight: bold; text-shadow: 1px 1px 1px rgba(0, 0, 0, .8);">Halaman Detail Pengaduan </div>
                    <div class="card-body">
                      <?php
                      ...
                      if ($result) :
                      ?>
                        <a href="verifikasi-petugas.php" class="btn btn-danger btn-icon-split">
                          <span class="icon text-white-50">
                            <i class="fas fa-arrow-circle-left"></i>
                          </span>
                          <span class="text">Kembali</span>
                        </a>
                        <a href="proses.php?id= <?= $data["id_pengaduan"]; ?>" class="btn btn-success btn-icon-split">
                          <span class="icon text-white-50">
                        ...
                        <form action="" method="post" enctype="multipart/form-data">
                          <div class="form-group">
                            ...
                            <input type="date" name="tgl_pengaduan" class="form-control" value="<?= $data["tgl_pengaduan"];  ?>" id="tgl" readonly>
                            <label for="isi" class="mt-3"> Isi Laporanya :</label>
                            <textarea name="isi_laporan" id="isi" style="height: 100px;" class="form-control"><?= $data["isi_laporan"]; ?> </textarea>
                            <label for="" class="mt-3">Foto Yg Dikirim :</label><br>
                            <img src="../img/<?= $data["foto"]; ?>" width="300px">
                        </form>
                      <?php endif; ?>
                    </div>
                  </div>
